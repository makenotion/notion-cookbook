...
| Promote an approved deployment or approve an incident rollback | [Vercel approved promotion and rollback](workers/vercel-promote-approved-deployment/) | Notion, Vercel, Redis |
