...
- **Bring external data into Notion:** use a Worker sync for
  ...
  [Todoist completed work](workers/todoist-completed-work-sync/),
...
| Keep a durable journal of completed tasks and projects       | [Todoist completed work](workers/todoist-completed-work-sync/) | Todoist    |
