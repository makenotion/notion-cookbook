...
`domain-guides/docket-inbox/SKILL.md` first** — it documents the two report kinds, the
...
match the parsers, follow the "Adapting" section in
`domain-guides/docket-inbox/SKILL.md` — the
