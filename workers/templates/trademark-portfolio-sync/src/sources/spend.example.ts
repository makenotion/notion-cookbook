...
// DEVELOPMENT.md (the ~5-minute per-execute budget) and
// domain-guides/sync-engine/SKILL.md ("Resolution budgeting").
//
...
// ~99KB in August 2026). See domain-guides/sync-engine/SKILL.md.
