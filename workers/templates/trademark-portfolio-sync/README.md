...
> step-by-step setup guide (finding your owner name, running `/setup` in
> Claude Code or asking another AI coding assistant to follow the same guide,
> connecting your counsel's docket reports, building views) that needs no
> terminal. The rest of this README is the developer-facing overview.
...
resilience design and outage runbook). **[AGENTS.md](AGENTS.md)** provides
the repository's canonical Worker guidance, while
**[DEVELOPMENT.md](DEVELOPMENT.md)** and
[`domain-guides/`](domain-guides/) document this recipe's engine, adapters,
docket formats, and document tools. Claude Code users can run `/setup`; other
assistants can follow `.claude/commands/setup.md`.
...
- **[AGENTS.md](AGENTS.md)** — canonical Worker guidance for AI coding assistants
- **[DEVELOPMENT.md](DEVELOPMENT.md)** — recipe-specific engineering rules and references
- **[Setup command](.claude/commands/setup.md)** — guided configuration and deployment
