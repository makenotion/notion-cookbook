...
For external services, read the [connections skill](.agents/skills/connections/SKILL.md).
It covers typed provider methods, workflow setup, connection-bound triggers,
OAuth access, and safe retries.
